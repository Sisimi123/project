    ...
    <div>
                        ...
                        <Row>
                            ...
                            <Col span="4">
                                <Form-item label="终端号码:">
                                    <Input v-model="query.wheres.termno" @on-keydown.enter="initSearch" placeholder="请输入..."></Input>
                                </Form-item>
                            </Col>
                            <div class="btn-wrap">
                            ...
                            <span style="float:right;text-align:right;">
                                <Button @click="showExcelDetail()"  type="info" icon="ios-cloud-upload-outline">导出Excel</Button>
                                <!-- <Button type="success" @click="beback()">返回上一级</Button> -->
                            </span>
                        </Row>
                    </Form>
                </div>
        ...
        <Modal :styles="{top: '50px'}" v-model="checkDetailModal" title="审核信息" width="50%" >
            <div style="height:550px;overflow: auto;padding:0px 10px 0px 0px">
                <Form  :label-width="105" ref="queryCheck" :model="queryCheck" :rules="ruleValidate">
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="点验日期:">
                                <Input v-model="queryDetail.dydate" readonly>
                                </Input> 
                            </FormItem>
                        </Col>   
                        <Col span="8">
                            <FormItem label="点验时间:">
                                <Input v-model="queryDetail.dytime" readonly>
                                </Input> 
                            </FormItem>
                        </Col>     
                        <Col span="8">
                            <FormItem label="渔船状态:">
                                <Input v-model="queryDetail.offline" readonly>
                                </Input> 
                            </FormItem>
                        </Col>             
                    </Row>
                    <Row>  
                        <Col span="8">
                            <FormItem label="是否离编:">
                                <Input v-model="queryDetail.outgroup" readonly>
                                </Input> 
                            </FormItem>
                        </Col>                 
                        <Col span="8">
                            <FormItem label="点验状态:">
                                <Input v-model="queryDetail.state" readonly>
                                </Input> 
                            </FormItem>
                        </Col>   
                        <Col span="8">
                            <FormItem label="核查人姓名:">
                                <Input v-model="queryDetail.auditorname" readonly>
                                </Input> 
                            </FormItem>
                        </Col>                 
                    </Row>
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="渔船名:">
                                <Input v-model="queryDetail.shipname" readonly>
                                </Input> 
                            </FormItem>
                        </Col>   
                        <Col span="8">
                            <FormItem label="所属机构:">
                                <Input v-model="queryDetail.organname" readonly>
                                </Input> 
                            </FormItem>
                        </Col>      
                        <Col span="8">
                            <FormItem label="船主姓名:">
                                <Input v-model="queryDetail.hostname" readonly>
                                </Input> 
                            </FormItem>
                        </Col>            
                    </Row>
                    <Row>  
                        <Col span="8">
                            <FormItem label="船东姓名:">
                                <Input v-model="queryDetail.owner" readonly>
                                </Input> 
                            </FormItem>
                        </Col>                 
                        <Col span="8">
                            <FormItem label="船员人数:">
                                <Input v-model="queryDetail.count" readonly>
                                </Input> 
                            </FormItem>
                        </Col>   
                        <Col span="8">
                            <FormItem label="联系电话:">
                                <Input v-model="queryDetail.tel" readonly>
                                </Input> 
                            </FormItem>
                        </Col>   
                    </Row>
                    <Row>
                        <Col span="8">
                            <FormItem label="卫星电话:">
                                <Input v-model="queryDetail.marineid" readonly>
                                </Input> 
                            </FormItem>
                        </Col> 
                        <Col span="8">
                            <FormItem label="航行状态:">
                                <Input v-model="queryDetail.sailStatus" readonly>
                                </Input> 
                            </FormItem>
                        </Col>               
                    </Row>
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="经度:">
                                <Input v-model="queryDetail.lon" readonly>
                                </Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem label="纬度:">
                                <Input v-model="queryDetail.lat" readonly>
                                </Input> 
                            </FormItem>
                        </Col>   
                        <Col span="8">
                            <FormItem label="航速:">
                                <Input v-model="queryDetail.heading" readonly>
                                </Input> 
                            </FormItem>
                        </Col>                  
                    </Row>
                    <Row>
                        <Col span="8">
                            <FormItem label="渔区:">
                                <Input v-model="queryDetail.grid" readonly>
                                </Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem label="最后报位时间:">
                                <Input v-model="queryDetail.postime" readonly>
                                </Input> 
                            </FormItem>
                        </Col> 
                        <Col span="8">
                            <FormItem label="港内港外:">
                                <Input v-model="queryDetail.port" readonly>
                                </Input> 
                            </FormItem>
                        </Col>                    
                    </Row>
                    <Row>
                        <Col span="8">
                            <FormItem label="最后报位终端:">
                                <Input v-model="queryDetail.termname" readonly>
                                </Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem label="最后报位终端号:">
                                <Input v-model="queryDetail.termno" readonly>
                                </Input> 
                            </FormItem>
                        </Col>                    
                    </Row>
                    ...
                    <Row>
                        <Col span="24">
                            <FormItem label="联系记录:">
                                <Input v-model="queryCheck.contactlog" type="textarea" :readonly="readonly" :autosize="{minRows: 3,maxRows: 5}">
                                </Input>
                            </FormItem>
                        </Col>                  
                    </Row>
                    <Row>
                        <Col span="8">
                            <FormItem label="渔船实际状态:">
                                <Select v-model="queryCheck.actualStatus" :disabled="disabled" :readonly="readonly">
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem label="离线原因:">
                                <Select v-model="queryCheck.offreason" :disabled="disabled" :readonly="readonly">
                        ...
                        <Col span="8">
                            <FormItem label="船员人数:" prop="sailorcount">
                                <Input v-model="queryCheck.sailorcount" :readonly="readonly" number>
                                </Input> 
                            </FormItem>
                        </Col>                    
                    </Row> 
                    <Row>
                        <Col span="10">
                            <FormItem label="状态确认:" prop="status">
                                <RadioGroup v-model="queryCheck.status" @on-change="handleStatus">
                                    <Radio label="1">疑似失联</Radio>
                                    <Radio label="2">确认安全</Radio>
                                </RadioGroup>
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
                        <Col span="24">
                            <FormItem label="备注:">
                                <Input v-model="queryCheck.note" type="textarea" :readonly="readonly" :autosize="{minRows: 3,maxRows: 5}">
                                </Input>
                            </FormItem>
                        </Col>                    
                    </Row> 
                    ...
                    <Row>
                        ...
                        <Col span="24">
                            <FormItem>
                                ...
                                <!-- <Input v-model="queryPlus.content" type="textarea" style="margin-top:5px;" :autosize="{minRows: 3,maxRows: 5}">
                                </Input> -->
                            </FormItem>
                        </Col>
                    </Row>
            ...
            <div slot="footer">
                ...
                <Button v-show="showCheckBtn" type="primary" @click="saveCheckMsg('queryCheck')">核查</Button> 
        ...
        <Modal :styles="{top: '220px'}" v-model="publishModal" title="发布信息" width="35%">
                <Form  :label-width="65">
                    <Row>
                        ...
                        <Col span="24">
                            <FormItem label="发布内容:">
                                <Input v-model="checkPub.content" type="textarea" readonly :autosize="{minRows: 3,maxRows: 5}">
                                </Input> 
                            </FormItem>
                        </Col>                
                    </Row>
        ...
        <Modal :styles="{top: '220px'}" v-model="BJpublishModal" title="补充处置内容" width="35%">
            <div>
                <Input v-model="queryPlus.content" type="textarea" style="margin-top:5px;" :autosize="{minRows: 8,maxRows: 8}">
                </Input>
            </div>
            <div slot="footer">
...
export default {
    ...
    data () {
        return {
            ruleValidate: {
                ...
                sailorcount: [
                    {required: false, message: '请填写数字', trigger: 'change', type:'number'}
                ]
            },
            ifCheck:"",
            publishModal:false,
    ...
    methods: {
        ...
        handleReset() {
            this.query.wheres.shipname = null;
            this.query.wheres.termno = null;
            this.query.type = "1";
            this.query.page = 1;
            this.query.size = 10;
            this.initSearch();
        ...
        showExcelDetail(){
            window.open(this.$basePath+"/check/dy/exportListXls?query="+encodeURI(JSON.stringify(this.query)));
        },
        handleStatus(v){
            var _self=this;
            if(_self.queryCheck.status=="1"){//actualStatus offreason
                _self.$forceUpdate();
                _self.$set(_self.queryCheck,'actualStatus',null);
                _self.$set(_self.queryCheck,'offreason',null);
                // _self.queryCheck.actualStatus=null;
                // _self.queryCheck.offreason=null;
                _self.disabled=true;
            }
            if(_self.queryCheck.status=="2"){
        ...
        saveCheckMsg(name){
            ...
            if(_self.queryCheck.status=="2"){
                if(_self.queryCheck.actualStatus==null&&_self.queryCheck.offreason==null){
                    _self.$Message.error("请选择渔船实际状态和离线原因");
                    return ;
                }
                if(_self.queryCheck.actualStatus==null){
                    _self.$Message.error("请选择渔船实际状态");
                    return ;
                }
                if(_self.queryCheck.offreason==null){
                    _self.$Message.error("请选择离线原因");
                    return ;
                }
            }
            // if (_self.queryCheck.sailorcount!=null || _self.queryCheck.sailorcount!=undefined ||_self.queryCheck.sailorcount!='') {
            //     if (isNaN(_self.queryCheck.sailorcount)) {
            //         _self.$Message.info('请填写数字')
            //         return
            //     }
            // }
            _self.queryCheck.dyId=_self.dyId;
            _self.$refs[name].validate((valid) => {
                if(valid){
                    _self.$http.post("/check/dy/check",_self.queryCheck)
                    .then(res=>{
                        if(res.success){
                            _self.$Message.info("核查成功");
                            _self.showCheckBtn=false;
                            _self.readonly=true;
                            _self.checkDetailModal = false
                            _self.initSearch();
                        }else{
        ...
        savePlusMsg(){
            ...
            if(_self.queryPlus.content==""||_self.queryPlus.content==undefined){
                _self.$Message.error("发布内容不能为空");
                return ;
            }
            _self.queryPlus.dyId=_self.dyId;
            _self.$http.post("/check/dy/bcczjl",_self.queryPlus)
            .then(res=>{
                if(res.success){
        ...
        checkDetail(row){
            ...
            _self.disabled=false;
            this.$refs["queryCheck"].resetFields();
            _self.$http.get("/check/dy/info?dyid="+row.id)
            .then(res=>{
                if(res.success){
                    ...
                    if(data.postime==undefined){
                        ...
                        _self.queryDetail.postime=_self.transDate(data.postime);
                    }
