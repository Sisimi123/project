        ...
        <div>
          <Row>
            <Col span="5">
              ...
              <Select v-model="statusCount" class="selec" @on-change="selectChange" >
            ...
            <Col span="19">
              <div style="margin-left:100px;">
                ...
                <checkbox-group v-model="intersecs" @on-change="checkBoxChange">
                  <checkbox label="shipownerStatus">
                      <span>船东</span>
                  </checkbox>
                  <checkbox label="telStatus">                
                      <span>电话</span>
                  </checkbox>
                  <checkbox label=shipLengthStatus>
                      <span>船长</span>
                  </checkbox>
                  <checkbox label="shipWidthStatus">
                      <span>船宽</span>
                  </checkbox>
                  <checkbox label="workTypeStatus">
                      <span>作业方式</span>
                  </checkbox>
                  <checkbox label="shipPowerStatus">
                      <span>主机功率</span>
                  </checkbox>
                  <checkbox label="ais">
                      <span>AIS</span>
