...
<div>
    <Modal
        ...
        <Form :label-width="100" :model="detail" :rules="infoRules" ref="info">
            ...
            <Row>
                <Col span=12>
                    <Form-item label="携带渔具数量：" :label-width="180">
                        <Input v-model="info.fishingGearNumber" placeholder="请输入携带渔具数量..."></Input>
                    </Form-item>
                </Col>
                <Col span=12>
                    <Form-item label="实际网目尺寸：" :label-width="180">
...
export default {
  ...
  data() {
    return {
        ...
        infoRules:{
            ...
            chuGangTime: [{required: true, type: 'date', message: '请选择出港时间', trigger: 'change'}],
  ...
  computed: {
    ...
    defaultWorkType(){
        ...
        console.log("enter defaultWorkType");
