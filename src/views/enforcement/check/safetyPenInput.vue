...
<div>
  ...
  <Modal :styles="{top: '40px'}" v-model="status.addModal" :title="title" width=800 :mask-closable="false" >
      <div id="zerenbook" style="height:600px;overflow:auto;">
          <input v-model="formLeft.status" type="hidden">
        <table class="regisbg"   border="1px" width=700 style="margin: 0 auto;">
              ...
              <tr>
                  ...
                  <td colspan="4">
                      ...
                      <input class="tql_penData-shipName" type="text" style="width:60%;height:80%" :readonly="readonly" v-model="formLeft.shipName">		
                  ...
                  <td colspan="4">
                          <input type="text"  class="whole-width tql_penData-masterAddress" :readonly="readonly" v-model="formLeft.masterAddress">
                  </td>
              </tr>

              <tr>
                  <td colspan="2" >所有人<span class="text-required">&nbsp;*</span></td>
                  <td colspan="4"><input type="text"  class="whole-width tql_penData-masterName" :readonly="readonly" v-model="formLeft.masterName"></td>
                  <td colspan="2">类别</td>
                  <td>应配数量</td>
                  <td>合格</td>
                  <td>缺少</td>
              ...
              <tr>
                  ...
                  <td colspan="4"><input type="text"  class="whole-width tql_penData-masterPhone" :readonly="readonly" v-model="formLeft.masterPhone"></td>
                  <td rowspan="4">救生设备</td>
                  <td>救生衣</td>
                  <td><input class="sl tql_penData-lifeJacketCount" v-model="formLeft.lifeJacketCount" :readonly="readonly" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-lifeJacketReality_' + index" :disabled="readonly"  v-model="formLeft.lifeJacketReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td>救生圈</td>
                  <td><input class="sl tql_penData-lifeBuoyCount" v-model="formLeft.lifeBuoyCount" :readonly="readonly" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-lifeBuoyReality_' + index" :disabled="readonly"  v-model="formLeft.lifeBuoyReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td colspan="1">无</td>
                  <td>救生浮</td>
                  <td><input class="sl tql_penData-lifeFloatCount" v-model="formLeft.lifeFloatCount" :readonly="readonly" type="text" /></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-lifeFloatReality_' + index" :disabled="readonly"   v-model="formLeft.lifeFloatReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td width="" v-for="(opt,index) in option"  :colspan="index ==0?2:1">
                    <input :class="'checkbox_cl tql_penData-registerQualifications_' + index" type="radio" :disabled="readonly" v-model="formLeft.registerQualifications" :value="opt">
                  </td>
                  <td>救生筏</td>
                  <td><input class="sl tql_penData-lifeRaftCount" :readonly="readonly" v-model="formLeft.lifeRaftCount" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-lifeRaftReality_' + index" :disabled="readonly"  v-model="formLeft.lifeRaftReality" :value="opt">
                  </td>                
              </tr>
              ...
              <tr> 
                  ...
                  <td v-for="(opt,index) in option"   :colspan="index==0?2:1">
                      <input :class="'checkbox_cl tql_penData-shipCheckQualifications_' + index" v-model="formLeft.shipCheckQualifications" :disabled="readonly" type="radio" :value="opt" >
                  </td>
                  <td rowspan="4">消防设备</td>
                  <td>灭火机</td>
                  <td><input class="sl tql_penData-fireExtinguisherCount" v-model="formLeft.fireExtinguisherCount" :readonly="readonly" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-fireExtinguisherReality_' + index" :disabled="readonly"  v-model="formLeft.fireExtinguisherReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td v-for="(opt,index) in option"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-catchLicence_' + index" :disabled="readonly" v-model="formLeft.catchLicence"  type="radio" :value="opt">
                  </td>
                  <td>灭火弹</td>
                  <td><input class="sl tql_penData-fireExtinguisherBombCount" :readonly="readonly" v-model="formLeft.fireExtinguisherBombCount" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-fireExtinguisherBombReality_' + index"  :disabled="readonly" v-model="formLeft.fireExtinguisherBombReality" :value="opt">
                  </td>
              ...
              <tr>
                  ...
                  <td v-for="(opt,index) in option" :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-navigationCertificate_' + index" v-model="formLeft.navigationCertificate" :disabled="readonly" type="radio" :value="opt">
                  </td>
                  <td>黄沙箱</td>
                  <td><input class="sl tql_penData-sandBoxCount" v-model="formLeft.sandBoxCount" :readonly="readonly" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-sandBoxReality_' + index" :disabled="readonly"  v-model="formLeft.sandBoxReality"  :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td>消防桶</td>
                  <td><input class="sl tql_penData-fireBucketCount" :readonly="readonly" v-model="formLeft.fireBucketCount"  type="text" /></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-fireBucketReality_' + index" :disabled="readonly"  v-model="formLeft.fireBucketReality" :value="opt">
                  </td>                    
              </tr>
              ...
              <tr>
                  ...
                  <td>桅灯</td>
                  <td><input class="sl tql_penData-rangeLightCount" :readonly="readonly" v-model="formLeft.rangeLightCount" type="text" /></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-rangeLightReality_' + index" :disabled="readonly"  v-model="formLeft.rangeLightReality" :value="opt">
                  </td>                    
              </tr>
              ...
              <tr>
                  ...
                  <td >船长</td>
                  <td v-for="(opt,index) in option"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-captainQualifications_' + index" :disabled="readonly" v-model="formLeft.captainQualifications" type="radio" :value="opt">
                  </td>
                  <td>舷灯</td>
                  <td><input class="sl tql_penData-sideLightCount" :readonly="readonly" v-model="formLeft.sideLightCount"  type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-sideLightReality_' + index" :disabled="readonly"  v-model="formLeft.sideLightReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  <td >大副</td>
                  <td v-for="(opt,index) in option"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-firstMateQualifications_' + index" :disabled="readonly" v-model="formLeft.firstMateQualifications" type="radio" :value="opt">
                  </td>
                  <td>锚灯</td>
                  <td><input class="sl tql_penData-ridingLightCount" v-model="formLeft.ridingLightCount" :readonly="readonly"  type="text" /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-ridingLightReality_' + index"  :disabled="readonly" v-model="formLeft.ridingLightReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  <td >二副</td>
                  <td v-for="(opt,index) in option"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-secondMateQualifications_' + index" :disabled="readonly" v-model="formLeft.secondMateQualifications" type="radio" :value="opt">
                  </td>
                  <td>尾灯</td>
                  <td><input class="sl tql_penData-tailLightCount" v-model="formLeft.tailLightCount" :readonly="readonly" type="text"  /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-tailLightReality_' + index" :disabled="readonly"  v-model="formLeft.tailLightReality" :value="opt">
                  </td>                    
              </tr>
              ...
              <tr>
                  <td >轮机长</td>
                  <td v-for="(opt,index) in option"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-chiefEngineerQualifications_' + index" :disabled="readonly" v-model="formLeft.chiefEngineerQualifications" type="radio" :value="opt">
                  </td>
                  <td>雾钟</td>
                  <td><input class="sl tql_penData-fogBellCount" v-model="formLeft.fogBellCount" :readonly="readonly" type="text"  /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-fogBellReality_' + index" :disabled="readonly"  v-model="formLeft.fogBellReality" :value="opt">
                  </td>                    
              </tr>
              ...
              <tr>
                  <td >大管轮</td>
                  <td v-for="(opt,index) in option"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-secondEngineerQualifications_' + index" :disabled="readonly" v-model="formLeft.secondEngineerQualifications" type="radio" :value="opt">
                  </td>
                  <td>号笛</td>
                  <td><input class="sl tql_penData-hooterCount" v-model="formLeft.hooterCount" :readonly="readonly" type="text" /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-hooterReality_' + index" :disabled="readonly"  v-model="formLeft.hooterReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  <td >二管轮</td>
                  <td v-for="(opt,index) in option"   :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-thirdEngineerQualifications_' + index" :disabled="readonly" v-model="formLeft.thirdEngineerQualifications" type="radio" :value="opt">
                  </td>
                  <td rowspan="6">通导设备</td>
                  <td>VHF</td>
                  <td><input class="sl tql_penData-vhfcount" v-model="formLeft.vhfcount" :readonly="readonly" type="text" /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-vhfreality_' + index" :disabled="readonly"  v-model="formLeft.vhfreality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td>单边带</td>
                  <td><input class="sl tql_penData-singleSidebandCount" :readonly="readonly" v-model="formLeft.singleSidebandCount" type="text"/></td>
                  <td v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-singleSidebandReality_' + index" :disabled="readonly"  v-model="formLeft.singleSidebandReality" :value="opt">
                  </td>                    
              </tr>

              <tr> 
                  <td colspan="2"><input class="tql_penData-fourSmallCardMust" :readonly="readonly" v-model="formLeft.fourSmallCardMust" type="text" /></td>
                  <td colspan="2"><input class="tql_penData-fourSmallCardReality" :readonly="readonly" v-model="formLeft.fourSmallCardReality" type="text"  /></td>
                  <td>卫导</td>
                  <td><input class="sl tql_penData-satelliteNavigatorCount" :readonly="readonly" v-model="formLeft.satelliteNavigatorCount" type="text" /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-satelliteNavigatorReality_' + index" :disabled="readonly"  v-model="formLeft.satelliteNavigatorReality" :value="opt">
                  </td>                    
              </tr>

              <tr>
                  <td colspan="2">技能合格证</td>
                  <td colspan="2"><input class="tql_penData-skillCertificateMust" :readonly="readonly" v-model="formLeft.skillCertificateMust" type="text" /></td>
                  <td colspan="2"><input class="tql_penData-skillCertificateReality" :readonly="readonly" v-model="formLeft.skillCertificateReality" type="text"/></td>
                  <td>雷达</td>
                  <td><input class="sl tql_penData-radarCount" :readonly="readonly" v-model="formLeft.radarCount"  type="text" /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-radarReality' + index" :disabled="readonly"  v-model="formLeft.radarReality" :value="opt">
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td>罗经</td>
                  <td><input class="sl tql_penData-compassCount" :readonly="readonly" v-model="formLeft.compassCount" type="text" /></td>
                  <td  v-for="(opt,index) in option2" > 
                      <input type="radio" :class="'checkbox_cl tql_penData-compassReality_' + index" :disabled="readonly"  v-model="formLeft.compassReality" :value="opt">
                  </td>                    
              </tr>
              ...
              <tr>
                  <td v-for="(opt,index) in option3"  :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-shipNumberIsClearly_' + index" :disabled="readonly" v-model="formLeft.shipNumberIsClearly" type="radio" :value="opt">
                  </td>
                  <td colspan="2" rowspan="2">有人值班</td>
                  <td colspan="2">职务船员值班</td>
                  <td colspan="2">
                    <input type="radio" class="'checkbox_cl tql_penData-watchState_职务船员值班" :disabled="readonly" value="职务船员值班" v-model="formLeft.watchState">
                  </td>
              </tr>
              <tr>
                  ...
                  <td colspan="2">
                    <input type="radio" disabled="readonly" class="checkbox_cl tql_penData-watchState_其他船员值班" value="其他船员值班" v-model="formLeft.watchState" >
                  </td>
              </tr>
              <tr>
                  <td v-for="(opt,index) in option3" :colspan="index==0?2:1">
                    <input :class="'checkbox_cl tql_penData-shipNameIsClearly_' + index"  v-model="formLeft.shipNameIsClearly" type="radio" :value="opt">
                  </td>
                  <td colspan="4">无人值班</td>
                  <td colspan="2">
                    <input type="radio" :disabled="readonly" class="checkbox_cl tql_penData-watchState_无人值班" value="无人值班" v-model="formLeft.watchState">
                  </td>
              </tr>
              <tr>
                  <td colspan="2" >七、其他违章情况：</td>
                  <td colspan="10" >
                      <textarea class="tql_penData-otherViolations" rows="2" cols="120" :readonly="readonly" v-model="formLeft.otherViolations"></textarea>
                  </td>
              </tr>
              <tr>
                  <td colspan="2" >八、整改措施：</td>
                  <td colspan="10">
                      <textarea class="tql_penData-makingCorrections" rows="2" :readonly="readonly" v-model="formLeft.makingCorrections" ></textarea>
                  </td>
              </tr>
              <tr>
                  <td class="text-left" colspan="4" rowspan="2">船长（船东）签名：</td>
                  <td class="text-left" colspan="4">检查人:
                      <input class="qm tql_penData-checkUser1" v-model="formLeft.checkUser1" :readonly="readonly" type="text" />、
                      <input class="qm tql_penData-checkUser2" v-model="formLeft.checkUser2" :readonly="readonly" type="text" />
                  </td>
                  <td class="text-left" colspan="4" rowspan="2">日期:
                      ...
                      <DatePicker class="tql_penData-checkDate" type="date" placeholder="选择时间" :readonly="readonly" v-model="formLeft.checkDate" style="width: 200px"></DatePicker>
                  </td>
              </tr>
            <tr>
                  <td class="text-left" colspan="4">执法证号:
                      <input class="qm tql_penData-checkUserCardNo1" v-model="formLeft.checkUserCardNo1" :readonly="readonly" type="text" />、
                      <input class="qm tql_penData-checkUserCardNo2" v-model="formLeft.checkUserCardNo2" :readonly="readonly" type="text" />
                  </td>
              </tr>

              <tr>
                  <td class="text-left" colspan="12">检查地址:
                    <input :readonly="readonly" class="mid-whole-width tql_penData-checkAddress" v-model="formLeft.checkAddress" type="text" />
                  </td>
              </tr>  
      ...
      <div slot="footer">
          ...
          <div v-show="!status.noteShow && selectStatus != '5'&&xg!=1 ">                            
              ...
              <i-Button @click="formPositionInfo" type="success">表单模型上传</i-Button>
              <i-Button @click="print" type="success">打印</i-Button>
          </div>
...
export default {
  ...
  methods: {
    ...
    formPositionInfo(){
      ...
      /**
       * 遍历所有td
       * 查询td中是否存在 input、textarea、DatePicker
       * 将td的xy、wd、id等数据放入数组
       * 数组格式：
       *    [
       *      {id,x,y,w,d}
       ...
       */
      // 搜寻td
      var tdList = form.find("td");
      var tdPositionArr = new Array();
      for(var td in tdList) {
        // 是数字
        if(!isNaN(td)) {
          var tdElement = $(tdList[td]);
          // 查询input
          var inputList = tdElement.find("input");
          // 查询textarea
          var textareaList = tdElement.find("textarea");
          // 查询datePicker
          var datePickerList = tdElement.find("datePicker");
          this.addTdPositionArr(tdPositionArr, tdElement, inputList);
          this.addTdPositionArr(tdPositionArr, tdElement, textareaList);
          this.addTdPositionArr(tdPositionArr, tdElement, datePickerList);
        }
      }
      console.log("tdPositionArr", tdPositionArr);
      // 发送点位
      this.sendPossitionArr({
        pageW: form.width(),
        pageH: form.height(),
        positionArr: tdPositionArr
      });
    },
    // 添加元素td位置
    addTdPositionArr(tdPositionArr, tdElement, list){
      var form = $("#zerenbook");
      for(var l in list) {
        if(!isNaN(l)) {
          var ele = $(list[l]);
          var className = ele.attr("class");
          var type = ele.attr("type")=="radio"?"*":"";
          className = this.analysisClassName(className);
          if(!className)
            continue;
          if(!isNaN(className.substr(className.indexOf("_") + 1))){
          // if(className.indexOf("_") > -1){
            // 结尾是数字的要替换为value
            className = type + className.substr(0, className.indexOf("_") + 1) + ele.attr("value");
          }
          // 获取xywh，传入相对的元素的位置
          var nxywh = this.getXYWH(tdElement, form.offset(), className);
          tdPositionArr.push(nxywh);
        }
      }
    },
    // 发送点位
    sendPossitionArr(positionObj){
      this.$http.post("/checks/safecheck/savePagePoint", {
        id: "safetyPenInput",
        pageW: positionObj.pageW,
        pageH: positionObj.pageH,
        positionJson: JSON.stringify(positionObj.positionArr)
      }).then(res => {
    ...
    analysisClassName(className){
      if(className.indexOf(" ") > -1){
        var spliceArr = className.split(" ");
        for(var l in spliceArr){
          className = spliceArr[l];
          if(className.indexOf("tql_penData") > -1)
            break;
        }
      }
      if(className.indexOf("tql_penData") == -1){
      ...
      spliceArr = className.split("-");
      for(var l in spliceArr){
        var className = spliceArr[l];
        if(className=="tql_penData")
          continue;
      }
      return className;
    },
    // 获取XYWH
    getXYWH(element, relativeObj, className){
      return {
        id: className,
        y:element.offset().top - relativeObj.top,
        x:element.offset().left - relativeObj.left,
        w:element.width(),
        h:element.height(),
      }
    },
