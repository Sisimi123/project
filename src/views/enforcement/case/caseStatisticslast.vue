    ...
    <div class="home-main">
        <Row :gutter="10">
            <Col span="8" :style="{marginTop: '10px'}">
                <Card title="案件办理状态统计">
                    <div id="current" style="height:401px;overflow:hidden;">                      
                    </div>
                </Card>
            </Col>
            <Col span="16" :style="{marginTop: '10px',}">
                <Card title="按地区统计" >
                    <div id="area" style="height:400px;overflow-y:auto;">
                        ...
                        <!-- <Button style='float:right' shape="circle" icon="ios-folder" type="primary" @click="exportTable">查询</Button>
        ...
        <Row :gutter="10">
            <Col span="8" :style="{marginTop: '10px'}">
                <Card title="按作业类型统计">
                    ...
                    状态：
                    <span style="">
                        <Select v-model="Statistics.work" @on-change="selectWork" style="width:120px" placeholder="选择作业类型">
                            <Option v-for="item in workStatus" :value="item.value" :key="item.value">{{item.name}}</Option>
                        </Select>
                    </span>
        ...
        <Row :gutter="10">
            ...
            <Col span="12" :padding="0" :style="{marginTop: '10px'}">
                <Card title="按案发时间统计">
