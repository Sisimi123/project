    ...
    <div class="content-wrap transactionRegist">
            ...
            <Form ref="caseInfo" :model="caseInfo" :rules="caseInfoRules" :label-width="100" >
                <div class="form-wrap" id="saay">
                    ...
                    <Row>
                        <Col span="23">
                            <FormItem label="涉嫌" prop="illegalAct">
                                <Input v-model="caseInfo.illegalAct" placeholder="请输入涉案案由" :readonly="ifEdit">
                                    <Button slot="append" @click="discretionary.show=!ifEdit" size="small">选择</Button>
                                </Input>
                            </FormItem>
                        </Col>
                        <Col span="1">
                    ...
                    <Row>
                        <Col span="24">
                            <FormItem label="处罚依据:" >
                                <Input v-model="caseInfo.punishAccording" placeholder="请输入处罚依据" :readonly="ifEdit"></Input> 
                            </FormItem>
                        </Col>
                    </Row>
                </div>
                    ...
                    <Row>
                        <Col span="12">
                            ...
                            <FormItem label="案发时间:"  prop="caseHappenTime">
                                <Date-picker type="datetime" :disabled="ifEdit" placement="bottom-start" v-model="caseInfo.caseHappenTime"  format="yyyy-MM-dd HH:mm"  placeholder="选择日期和时间"  :clearable="false"></Date-picker>
                            </FormItem>
                        </Col>
                        <Col span="6">
                        ...
                        <Col span="12">
                            <FormItem label="东经:">
                                <Row>
                                    <Col span="8">
                                        <FormItem prop="lonDu">
                                            <Input :readonly="ifEdit" v-model="caseInfo.lonDu"  placeholder="请输入经度"  @on-blur="()=>computeFishGrid('lonDu',180)"  @on-keydown="keydown" number><span slot="append">度</span></Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="8">
                                        <FormItem prop="lonFen">
                                            <Input :readonly="ifEdit" v-model="caseInfo.lonFen"  placeholder="请输入经度"  @on-blur="()=>computeFishGrid('lonFen',60)"  @on-keydown="keydown" number><span slot="append">分</span></Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="8">
                                        <FormItem prop="lonMiao">
                                            <Input :readonly="ifEdit" v-model="caseInfo.lonMiao"  placeholder="请输入经度"  @on-blur="()=>computeFishGrid('lonMiao',60)"  @on-keydown="keydown" number><span slot="append">秒</span></Input>
                                        </FormItem>
                                    </Col>
                                </Row>
                            </FormItem>
                        ...
                        <Col span="12">
                            <FormItem label="北纬:">
                                <Row>
                                    <Col span="8">
                                        <FormItem prop="latDu">
                                            <Input :readonly="ifEdit" v-model="caseInfo.latDu"  placeholder="请输入纬度"   @on-blur="()=>computeFishGrid('latDu',90)"  @on-keydown="keydown" number><span slot="append">度</span></Input>
                                        </FormItem>    
                                    </Col>
                                    <Col span="8">
                                        <FormItem prop="latFen">
                                            <Input :readonly="ifEdit" v-model="caseInfo.latFen"  placeholder="请输入纬度"   @on-blur="()=>computeFishGrid('latFen',60)"  @on-keydown="keydown" number><span slot="append">分</span></Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="8">
                                        <FormItem prop="latMiao">
                                            <Input :readonly="ifEdit" v-model="caseInfo.latMiao"  placeholder="请输入纬度"  @on-blur="()=>computeFishGrid('latMiao',60)"  @on-keydown="keydown" number><span slot="append">秒</span></Input>
                                        </FormItem>
                                    </Col>
                                </Row>
                            </FormItem>
                    ...
                    <Row>
                        ...
                        <Col span="16"  v-show="caseInfo.caseType=='陆上'">
                            <FormItem label="地点:"  prop="caseHappenAddress">
                                <Input :readonly="ifEdit" v-model="caseInfo.caseHappenAddress" placeholder="请输入地点">
                    ...
                    <Row>
                        <Col span="12">
                            <FormItem label="执法人:"  prop="lawMan2">
                                ...
                                <Input :readonly="ifEdit" v-model="caseInfo.lawMan2" placeholder="请输入执法人"  >
                                    <Button slot="append" @click="searchLawMan" size="small">选择</Button>
                                </Input> 
                                
                                <!-- 
                                <select ref="lawMan2"  v-model="caseInfo.lawMan2"    :clearable="true"  :filterable="true" :remote="true"  @on-query-change="searchLawer"  :loading="loading"  @on-change="selectLawer"   transfer placeholder="请输入执法人" >
                                        <Option  v-for="lawer in lawMans"  :value="lawer.id"  :key="lawer.id">{{lawer.owner}}({{lawer.yzzfh}})</Option> 
                                </select> 
                                -->
                            </FormItem>
                        </Col>
                        <Col span="12">
                            <FormItem label="执法号:"  prop="lawMan2Num">
                                <Input :readonly="ifEdit" v-model="caseInfo.lawMan2Num"   placeholder="请输入执法号"></Input> 
                            </FormItem>
                        </Col>
                        
                        <!-- <Col span="2">
                            &nbsp;&nbsp;
                            <Button type="info"  size="default"  @click="addEnforcers()">增加</Button>
                        </Col> -->
                       
                    </Row>
                    <!-- <template v-for="(item,index) in caseInfo.enforcers">
                        <Row>
                            <Col span="12">
                                <FormItem label="执法人:" >
                                    <Input  :id="'lawMan_'+index"  :value="item.lawMan" placeholder="请输入执法人"   >
                                        <span slot="append"  @click="searchEnforcers(index)" >选择</span>
                                    </Input> 
                                </FormItem>
                            </Col>
                            <Col span="10">
                                <FormItem label="执法号:" >
                                    <Input  :id="'lawManNumber_'+index" :value="item.lawManNumber"   placeholder="请输入执法号"   @on-keyup="changeEnforcer"></Input> 
                                </FormItem>
                            </Col>
                            <Col span="2">
                                <i-Button type="error" size="small"  @click="delEnforcers(index)">删除</i-Button>
                            </Col>
                        </Row>
                    </template> -->
                ...
                <div class="form-wrap" id="dstxx">
                    ...
                    <Row>
                        <Col span="8">
                            ...
                            <FormItem prop="shipname" label="船舶名称:" v-show="false">
                                <Input :readonly="true" v-model="caseInfo.shipinfo.shipname" placeholder="清选中渔船">
                        ...
                        <Col span="8">
                            <FormItem prop="shipworkmode" label="证载作业方式:"  :label-width="120" >
				                <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.workmode" placeholder="请输入证载作业方式"></Input> 
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
                        ...
                        <Col span="8">
                            <FormItem prop="shipownertel" label="持证人电话:">
                                <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.ownertel" placeholder="请输入持证人电话" :maxlength="11"  @on-keydown="keydown"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem prop="shipownercert" label="身份证/企业注册号:" :label-width="120" >
								<Input :readonly="ifEdit" v-model="caseInfo.shipinfo.certno" placeholder="请输入身份证/企业注册号"  :maxlength="18"></Input> 
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
                        ...
                        <Col span="8">
                            <FormItem prop="shipwidth" label="型宽:">
                                <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.width" placeholder="请输入型宽" :maxlength="11"  @on-keydown="keydown">
                                    <span slot="append" >米</span>
                                </Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem prop="shipdepth" label="型深:" :label-width="120" >
								<Input :readonly="ifEdit" v-model="caseInfo.shipinfo.depth" placeholder="请输入型深"  :maxlength="18">
                                    <span slot="append" >米</span>
                                </Input> 
                            </FormItem>
                        </Col>
                    ...
                    <Row>
                        ...
                        <Col span="8">
                            <FormItem prop="shipmaterial" label="材质:">
                                <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.material" placeholder="请输入材质" :maxlength="11"  @on-keydown="keydown"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem prop="litigantname" label="姓名:">
                                <Input :readonly="ifEdit" ref="litigantsName"  v-model="caseInfo.litigants.name" placeholder="请输入姓名"   :disabled="disableUnit"   @on-blur="blurLitigants('name')"></Input>
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem prop="litiganttellphone" label="电话:">
								<Input :readonly="ifEdit" v-model="caseInfo.litigants.tellphone" placeholder="请输入电话"  :maxlength="11"  @on-keydown="keydown"  :disabled="disableUnit"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem prop="litigantidentiId" label="身份证号码:" :label-width="100" >
                                <Input :readonly="ifEdit" v-model="caseInfo.litigants.identiId"  @on-blur="calculateAge"  placeholder="请输入身份证号码"  :maxlength="18"  :disabled="disableUnit"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem prop="litigantage" label="年龄:">
								<Input :readonly="ifEdit" v-model="caseInfo.litigants.age" placeholder="请输入年龄"  :maxlength="3"  @on-keydown="keydown"  :disabled="disableUnit"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem prop="litigantpolitical" label="政治面貌:">
                                <Select v-model="caseInfo.litigants.political" placeholder="请输入政治面貌" :disabled="ifEdit">
                    ...
                    <Row>
                      <Col span="24">
                            <FormItem prop="litigantaddress" label="联系地址:">
                                <Input :readonly="ifEdit" v-model="caseInfo.litigants.address" placeholder="请输入联系地址"  :disabled="disableUnit"></Input> 
                            </FormItem>
                        </Col>
                    </Row>
                    <!-- <fieldset class="title">
                    ...
                    <Row>
                        <Col span="8">
                            <FormItem prop="litigantunitName" label="单位名称:">
							    <Input v-model="caseInfo.litigants.unitName" placeholder="请输入单位名称"  :disabled="disableName"  @on-blur="blurLitigants('unit')"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                    ...
                    <Row>
                        ...
                        <Col span="8">
                            <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.blxkzbz" placeholder="请输入备注">
                                <Button slot="append" icon="eye"  @click="showShipModal('ycblxk')"></Button>
                            </Input>
                            <!-- <Button type="primary"  @click="shipModal.ycjb=true">渔船基本信息</Button> -->
                        </Col>
                    </Row>
                    <Row>
                        <Col span="12">
                        ...
                        <Col span="8">
                            <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.cjzbz" placeholder="请输入备注">
                                 <Button slot="append" icon="eye"  @click="showShipModal('ycjy')"></Button>
                            </Input>
                        </Col>
                    </Row>
                    <Row>
                        ...
                        <Col span="8">
                            <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.cbsyqbz" placeholder="请输入备注">
                                 <Button slot="append" icon="eye"  @click="showShipModal('ycsyq')"></Button>
                            </Input>
                        </Col>
                    </Row>
                </div>
                ...
                <div class="form-wrap" id="syyjqk" v-show="showShip">
                    ...
                    <Row>
                        <Col span="12">
                            <FormItem label="网具数量:" prop="name">
                                <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.wjsl" placeholder="请输入网具数量"  @on-keydown="keydown">
                                        <span slot="append">（顶/张）</span>
                                </Input> 
                            </FormItem>
                        </Col>
                        <Col span="12">
                            <FormItem label="网目尺寸:" prop="mail">
                                <Input :readonly="ifEdit" v-model="caseInfo.shipinfo.wmcc" placeholder="请输入网目尺寸"  @on-keydown="keydown">
                ...
                <div class="form-wrap" id="yhwqk" v-show="showShip">
                    ...
                    <Row>
                        <Col span="24" >
                            <FormItem label="渔获物:" >
                            <Input :readonly="ifEdit" v-model="caseInfo.catchfishs"  type="textarea"  :rows="4"  placeholder=""></Input>
                            </FormItem>
                        </Col>
                    </Row>
                </div>
                <div class="form-wrap" id="ajbh">
                    ...
                    <Row>
                        <Col span="8" >
                            <FormItem label="案件文种"  prop="enforceType">
                                <Input v-model="caseInfo.enforceType" placeholder="请输入案件文种"  @on-change="getEnforceNum"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem label="案件年份:"  prop="enforceYear">
                                <Input v-model="caseInfo.enforceYear" placeholder="请输入案件年份"  @on-change="getEnforceNum"></Input> 
                            </FormItem>
                        </Col>
                        <Col span="8">
                            <FormItem label="案件文号:"  prop="enforceNum">
                                <Input v-model="caseInfo.enforceNum" placeholder="请输入案件文号"></Input> 
                            </FormItem>
                        </Col>
                    </Row>
                    -->
                    <Row>
                        <Col span="24" >
                            <FormItem label="案件编号:">
                                <Input :readonly="ifEdit" search v-model="caseInfo.enforceType" placeholder="请输入案件文种"  @on-change="getEnforceNum" style="width:200px;display: inline-table;">
                                    <span slot="prepend" @click="loadEnforceType" style="cursor:pointer">▼</span>
                                    <span slot="append">罚字</span>
                                </Input>
                                <Input :readonly="ifEdit" v-model="caseInfo.enforceYear" placeholder="请输入案件年份"  @on-change="getEnforceNum" style="width:200px;display: inline-table;">
                                    <span slot="prepend">〔</span>
                                    <span slot="append">〕</span>
                                </Input> 
                                <Input :readonly="ifEdit" v-model="caseInfo.enforceNum" placeholder="请输入案件文号" style="width:200px;display: inline-table;">
                ...
                <div class="form-wrap" id="ajms" v-show="caseInfo.status>=0">
                    ...
                    <Row>
                        <Col span="24" >
                            <FormItem label="案情描述:" >
                            <Input :readonly="ifEdit" v-model="caseInfo.caseContent"  type="textarea"  :rows="4"  placeholder=""></Input>
                            </FormItem>
                        </Col>
                    </Row>
                </div>
                <div class="form-wrap" id="ajss" v-show="caseInfo.status>0">
                    ...
                    <Row>
                        <Col span="24" >
                            <FormItem label="案件事实:" >
                            <Input :readonly="ifEdit" v-model="caseInfo.fact"  type="textarea"  :rows="4"  placeholder=""></Input>
                            </FormItem>
                        </Col>
                    </Row>
                </div>
                <div class="form-wrap" id="cfjds" v-show="caseInfo.status>1">
                    ...
                    <Row>
                        <Col span="24" >
                            <FormItem label="全文/摘要:" >
                            <Input :readonly="ifEdit" v-model="caseInfo.punishContent"  type="textarea"  :rows="4"  placeholder=""></Input>
                            </FormItem>
                        </Col>
                    </Row>
                </div>
                <div class="form-wrap" id="zxjg" v-show="caseInfo.status>1">
                    ...
                    <Row>
                        <Col span="24" >
                            <FormItem label="执行结果:" >
                            <Input :readonly="ifEdit" v-model="caseInfo.executeresult"  type="textarea"  :rows="4"  placeholder=""></Input>
                            </FormItem>
                        </Col>
                    </Row>
                </div>
                <div class="form-wrap" id="zpzj">
                    <fieldset class="title">
                        <legend>照片证据</legend>
                    </fieldset>
                    <Row>
                        <Col span="24">
                            <ul class="ivu-upload-list">
                                <li class="ivu-upload-list-file ivu-upload-list-file-finish"  v-for="(item,index) in uploadList" :key="index">
                                    <span  @click="showFile(item)"><i class="ivu-icon ivu-icon-image"></i> {{item.name}}</span> 
        ...
        <div class="right-button">
            <div class="btn-wrap" v-show="paramsView=='1'">
                ...
                <input class="green" type="button" value="制作现场笔录" @click="makeWs('R1')"/>
                <input class="green" type="button" value="制作询问笔录" @click="makeWs('R3')"/>
                <input class="green" type="button" value="立案审批" @click="makeWs('R2',true)"/>
                <input class="orange" type="button" value="保存" @click="saveDraft"/>
                <input class="orange" type="button" value="提交" @click="submitLian"/>
            ...
            <div class="btn-wrap" v-show="paramsView=='2'">
                <!--
                <input class="green" type="button" value="制作案件处理意见书" @click="makeWs('R4')"/>
                <input class="green" type="button" value="制作行政处罚事先告知书" @click="makeWs('R5')"/>
                <input class="green" type="button" value="制作陈述申辩笔录" @click="makeWs('DSRCS')"/>
                <input class="green" type="button" value="制作行政处罚审批表" @click="makeWs('R6',true)" />
                <input class="green" type="button" value="制作行政处罚决定书" @click="makeWs('R8')" />
                -->
                <input class="green" type="button" value="添加文书" @click="addDoc(true)" />
            ...
            <div class="btn-wrap" v-show="paramsView=='8'">
                <!--
                <input class="green" type="button" value="制作行政结案报告" @click="makeWs('R10',true)" />
                -->
                <input class="green" type="button" value="添加文书" @click="addDoc(true)" />
                <input class="green" type="button" value="启动流程" @click="startWorkFlow(true)" />
        ...
        <Modal id="discretionary"
            v-model="discretionary.show"
            title="选择自由裁量"
            :scrollable="true">
        ...
        <Modal id="draftBox"
            ...
            :scrollable="true" >
                <Row>
                    <Col>
                        <Input v-model="draft.query.wheres.search" placeholder="请输入查询条件..." style="width: 300px"  @on-enter="draftSearch"></Input>
                        <Button type="primary"  icon="ios-search"  @click="draftSearch">搜索</Button> 
                    </Col>
                </Row>
                <Row>
                    <Col class="margin-top-5">
                        <Table size="small" border :columns="draft.columns" :data="draft.data" @on-row-dblclick="draftDBClick" height="282"></Table>
                    </Col>
                </Row>
                <div slot="footer">
                    <Page size="small" :current="draft.query.page"  :total="draft.dataTotal" :page-size="draft.query.size"  @on-change="draftPage" show-elevator show-total ></Page>
                </div>
        </Modal>

      

        <Modal id="wsFlowModel"
            v-model="wsFlow.show"
            title="文书"
            :width="620"
            :scrollable="true" >
        ...
        <Modal id="enforceTypeBox"
            v-model="enforceType.show"
            title="案件编号"
            :width="450">
                ...
                <div slot="footer">
                    <template v-if="enforceType.action=='edit'">
                        ...
                        <Button type="primary"  @click="saveEnforceType">保存</Button>
                    </template>
                    <template v-else>
                        <Button type="error"  @click="enforceType.show=false">关闭</Button>
                        <Button type="primary" @click="enforceType.action='edit'" >新增</Button>
                    </template>
                </div>
        </Modal>
        ...
        <workflowModal v-model="workflow.show" :taskId="workflow.taskId" :instanceId="workflow.instanceId" :businessKey="workflow.businessKey" :category="workflow.category"></workflowModal>
        <MultiUpload v-model="cardShow" :dataId="caseInfo.id"  moduleId="EnforceCaseInfo" :action="paramsView=='9'?'view':'edit'" ></MultiUpload>
...
import enforcers from '@/views/components/case/enforcers.vue';
...
//			    caseHappenLatitude: "000°00.000′",
           	...
           	caseInfoRules: {
                caseSource: [{required: true, type: 'string', message: '请选择案件来源', trigger: 'change',transform:value=>value?value.trim():''}],
                caseType: [{required: true, type: 'string', message: '请选择案件类型', trigger: 'change',transform:value=>value?value.trim():''}],
                illegalAct: [{required: true, type: 'string', message: '请选择案由', trigger: 'change', transform:value=>value?value.trim():''}],
                caseHappenTime: [{required: true, type: 'date', message: '请选择案发时间', trigger: 'change' }],
                enforceMain: [{required: true, type: 'string', message: '请选择案件主体', trigger: 'change' }],
                // caseHapeenLongitude: [
                ...
                //     }}            
                // ],
                lonDu: { required: false, type: 'number', message: '请输入正确的经度', trigger: 'blur' },
                lonFen: { required: false, type: 'number', message: '请输入正确的经度', trigger: 'blur' },
                lonMiao: { required: false, type: 'number', message: '请输入正确的经度', trigger: 'blur' },
                latDu: { required: false, type: 'number', message: '请输入正确的纬度', trigger: 'blur' },
                latFen: { required: false, type: 'number', message: '请输入正确的纬度', trigger: 'blur' },
                latMiao: { required: false, type: 'number', message: '请输入正确的纬度', trigger: 'blur' },
				// caseHappenLatitude: [{required: true, type: 'string', message: '请输入纬度', trigger: 'blur' }],
                // enforceType: [{required: true, type: 'string', message: '请输入案件文种', trigger: 'change' }],
                // enforceYear: [{required: true, type: 'string', message: '请输入案件年份', trigger: 'change' }],
            	// enforceNum: [{required: true, type: 'string', message: '请输入案件文号', trigger: 'blur' }],
            	// enforceNum: [{required: true, type: 'string', message: '请输入案件文号', trigger: 'change' }],
                // enforceNum:[{validator:function(rule, value, callback){
                //     var enforceNum=_self.caseInfo.enforceNum;
                //     if (isNull(enforceNum)&&isNull(enforceNum)) {
                //         return callback(new Error('请输入案件文号'));
                //     }
                //     callback();
                // },trigger: 'blur'}],
                lawMan: [{required: true, type: 'string', message: '请选择执法人', trigger: 'change',transform:value=>value?value.trim():'' }],
                lawManNum: [{required: true, type: 'string', message: '请选择执法号', trigger: 'change',transform:value=>value?value.trim():'' }],
                lawMan2: [{required: true, type: 'string', message: '请选择执法人', trigger: 'change',transform:value=>value?value.trim():'' }],
                lawMan2Num: [{required: true, type: 'string', message: '请选择执法号', trigger: 'change',transform:value=>value?value.trim():'' }],
                litigantname:[{validator:function(rule, value, callback){
                ...
                litigantsex:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                ...
                /*
                litiganttellphone:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.name)&& isNull(l.tellphone)) {
                        return callback(new Error('请选择当事人联系电话'));
                    }
                    callback();
                }, trigger: 'change'}],
                litigantage:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.name)&& isNull(l.age)) {
                        return callback(new Error('请输入当事人年龄'));
                    }
                    callback();
                }, trigger: 'change'}],
                litigantidentiId:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.name)&& isNull(l.identiId)) {
                        return callback(new Error('请输入当事人身份证号'));
                    }
                    callback();
                },trigger: 'change'}],
                litigantaddress:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.name)&& isNull(l.address)) {
                        return callback(new Error('请输入当事人联系地址'));
                    }
                    callback();
                }, trigger: 'change'}],
                */
                litigantunitName:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                ...
                /*
                litigantfaren:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.unitName)&& isNull(l.faren)) {
                        return callback(new Error('请输入法人姓名'));
                    }
                    callback();
                }, trigger: 'change'}],
                litigantunitAddress:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.unitName)&& isNull(l.unitAddress)) {
                        return callback(new Error('请输入单位地址'));
                    }
                    callback();
                }, trigger: 'change'}],
                litigantunitTell:[{validator:function(rule, value, callback){
                    var l= _self.caseInfo.litigants;
                    if (! isNull(l.unitName)&& isNull(l.unitTell)) {
                        return callback(new Error('请输入单位联系电话'));
                    }
                callback();
                },trigger: 'change'}],
                */
                shipowner:[{validator:function(rule, value, callback){
                ...
                shipownertel:[{validator:function(rule, value, callback){
                    var s= _self.caseInfo.shipinfo;
                ...
                shipownercert:[{validator:function(rule, value, callback){
                    var s= _self.caseInfo.shipinfo;
                ...
                shipcjg:[{validator:function(rule, value, callback){
                    var s= _self.caseInfo.shipinfo;
                ...
                /*
                shipworkmode:[{validator:function(rule, value, callback){
                    var s= _self.caseInfo.shipinfo;
                    if (! isNull(s.shipName)&& isNull(s.workmode)) {
                        return callback(new Error('请输入证载作业方式'));
                    }
                callback();
                },trigger: 'blur'}],
                */
                // shipblxkz:[{validator:function(rule, value, callback){
                //     var c= _self.caseInfo;
                //     if (! isNull(c.shipinfo.shipName)&& isNull(c.shipinfo.blxkz)) {
                //         return callback(new Error('请选择捕捞许可证情况'));
                //     }
                // callback();
                // },trigger: 'change'}],
                // shipcjz:[{validator:function(rule, value, callback){
                //     var c= _self.caseInfo;
                //     if (! isNull(c.shipinfo.shipname)&& isNull(c.shipinfo.cjz)) {
                //         return callback(new Error('请选择船检证情况'));
                //     }
                // callback();
                // },trigger: 'change'}],
                // shipcbsyq:[{validator:function(rule, value, callback){
                //     var c= _self.caseInfo;
                //     if (! isNull(c.shipinfo.shipname)&& isNull(c.shipinfo.cbsyq)) {
                //         return callback(new Error('请选择船舶所有权情况'));
                //     }
                // callback();
                // },trigger: 'change'}],
                caseHappenAddress:[{validator:function(rule, value, callback){
                    var c= _self.caseInfo;
				...
				columns:[
					...
					},
					{
					    ...
					    render: function(h, params) {
					    	...
					    	var temp=(text.length>20)?(text.substring(0,22)+"..."):text;
					    	return h("span",temp);
					    }
					},
					{
    ...
    beforeRouteLeave (to, from, next) {
        ...
        if (urls=="/enforcement/caseIndex" || urls=="/enforcement/case/addCase") {
    ...
    computed:{
        ...
        ownCase(){
            ...
            return !isNull(this.caseInfo.id)&& !isNull(userInfo) && userInfo.userId==this.caseInfo.creatorId&&status!="8";
        },
        hasAdminRole(){
    ...
    methods: {
        ...
        selectLeftMenu: function(id) {
            this.leftActive = id;
            var top=$("#content").scrollTop() + $(id).offset().top - $("#content").offset().top-30;
        ...
        onSelectShip(row){
            console.log(row);
            this.caseInfo.shipinfo.shipname=row.nametheShip;
            this.caseInfo.shipinfo.owner=row.namevesselOwner;
            this.caseInfo.shipinfo.ownertel=row.shipOwnerTelephone;
            this.caseInfo.shipinfo.certno=row.holdIdenCardNumbRegiNumb;
            this.caseInfo.shipinfo.cjg=row.portregistry;
            this.caseInfo.shipinfo.power=row.masterPower;
            this.caseInfo.shipinfo.workmode=row.mainJobFirstOperationMode;
            this.caseInfo.shipinfo.length=row.typeLength;
            this.caseInfo.shipinfo.width=row.typeWidth;
            this.caseInfo.shipinfo.depth=row.shipDepth;
            this.caseInfo.shipinfo.material=row.hullMaterialA;
            // this.caseInfo.shipinfo.positioncrews=row.positioncrews;
            this.caseInfo.shipinfo.blxkz=row.xkz;
            this.caseInfo.shipinfo.blxkzh=row.fishingLicenseNumberA;
            this.caseInfo.shipinfo.cjz=row.cj;
            this.caseInfo.shipinfo.cbsyq=row.syq;
            var owner=row.namevesselOwner;
            if(!isNull(owner)){
                this.caseInfo.litigants.name=row.namevesselOwner;
                this.caseInfo.litigants.tellphone=row.shipOwnerTelephone;
                this.caseInfo.litigants.identiId=row.holdIdenCardNumbRegiNumb;
                this.caseInfo.litigants.address=row.addressshipOwner;
                this.caseInfo.litigants.political="";
                var cardno=row.mainJobFirstOperationMode;
                if(!isNull(cardno)&&cardno.length==18)
        ...
        computeFishGrid(name,num){
            ...
            if(caseInfo.caseType=='海上'&&!isNull(caseInfo.lonDu)&&!isNull(caseInfo.latDu)){
                var lon=(parseFloat(caseInfo.lonDu)+parseFloat(caseInfo.lonFen)/60+parseFloat(caseInfo.lonMiao)/3600);
                var lat=(parseFloat(caseInfo.latDu)+parseFloat(caseInfo.latFen)/60+parseFloat(caseInfo.lonMiao)/3600);
                if(lon==0||lat==0)
                    return;
                _self.$http.get("/enforces/case/fishgrid",{
                    params:{
                        lon:lon,
                        lat:lat
                    }
        ...
        keydown(event){
            if ((event.ctrlKey && window.event.keyCode==67)||(event.ctrlKey && window.event.keyCode==86)||(event.keyCode >= 48 && event.keyCode <=57)||(event.keyCode >= 96 && event.keyCode <=105)||event.keyCode==8 ||event.keyCode==190||event.keyCode==189)
        ...
        showFile:function(item){
            ...
            if(suffix!=''&&(".bmp,.jpg,.png,.jpeg,.tiff,.gif".indexOf(suffix.toLowerCase())>=0)){
        ...
        selectDiscretionaryPower(nodes){
            ...
            if(!isNull(node.children) && node.children.length>0){
                ...
                // this.$util.expandTree(this.discretionary.dataList,node.id);
        ...
        //         // _self.$http.get("/enforces/wenshou/loadDoneAndUndoWsList",{
        //         //     params:{
        ...
        //         // .then(function(result){
        //         //     if(result.success){
        //         //         _self.wenshou.sdata=result.data.sdata;
        //         //         _self.wenshou.tdata=result.data.tdata;
        //         //     }
        ...
        //         params:{
        //             caseId:_self.caseInfo.id,
        //             docType:params.row.id
        //         }
        //     }).then(function(result){
        //         if(result.success){
        //             _self.wenshou.sdata.splice(params.index,1);
        //             _self.wenshou.tdata.push(result.data);
        //         }
        //     });
        // },

        // // makeWs_bak(docType,isFlow){
        // //     var _self=this;
        // //     _self.confirmSaveCase(function(){
        // //         _self.$router.push({path:"/enforcement/doc/index",query:{
        // //             docType:docType,
        // //             caseId:_self.caseInfo.id,
        // //             isFlow:isFlow,
        // //             edit:1
        ...
        //                     isFlow:isFlow,
        //                 };
        //             _self.existsWs(params,function(wsId){
        //                 params.wsId=wsId;
        //                 openPageOffice(_self,params);
        //             });
        //         }
        //     });
        // },
        ...
        //     });
        // },
        // existsWs(params,handler){
        //     var _self=this;
        //     _self.$http.get("/enforces/wenshou/existsWs",{
        //         params:{
        ...
        loadWsList(docType,handler){
            var _self=this;
            _self.$http.get("/enforces/wenshou/getWsList",{
                params:{
                    docType:docType,
                    caseId:_self.caseInfo.id,
                }
        ...
        startWorkFlow(){
            var _self=this;
            _self.$http.get("/enforces/wenshou/loadUndoWsFlowList",{
                params:{
                    caseId:_self.caseInfo.id
                }
            }).then(function(result){
        ...
        vaildTask:function(docType,description,handler){
            ...
            _self.$http.get("/enforces/wenshou/existsTask",{
                params:{
                    docType:docType,
                    caseId:caseId
                }
        ...
        saveCaseInfo(handler,error){
            ...
            if(isEmpty(caseId)){
                ...
                this.$http.post("/enforces/case",_self.caseInfo).then(handler).catch(error);
            }else{
                this.$http.put("/enforces/case/"+caseId,_self.caseInfo).then(handler).catch(error);
            }
        },
        saveDraft(){
            var _self=this;
        ...
        submitJiean(){
            ...
            _self.vaildTask("R10","请先行政处罚结案报告！",function(){
                _self.$Modal.confirm({
                    ...
                    content:"请确认是否结案归档！",
                    onOk:function(){
                        _self.$http.get("/enforces/wenshou/processWs/"+_self.caseInfo.id)
                        .then(function(result){
                            if(result.success){
                                var data=result.data;
                                ...
                                _self.saveCaseInfo(function(result){
                                    if(result.success){
                                        _self.updatedIndex = 0;
                                        _self.$router.push({path:"/enforcement/caseIndex"});
                                    }
                                    _self.$Message.info(result.msg);
                                });
                            }
        ...
        submitGoto(view){
            ...
            _self.$Modal.confirm({
                ...
                cancelText:"返回首页",
                onOk(){
                    _self.$router.push({path:"/enforcement/case/addCase",query:{caseId:_self.caseInfo.id,view:view}});
                },
                onCancel(){
                    _self.$router.push({path:"/enforcement/caseIndex"});
                }
        ...
        loadCase(caseId){
            var _self=this;
            this.$http.get("/enforces/case/"+caseId)
                .then(function(result){
                    if(result.success){
                        var $shipName=_self.$refs['shipName'];
                        $shipName.$off("on-change");
                        $shipName.$off("on-query-change");
                        result.data.caseHappenTime=new Date(result.data.caseHappenTime.replace(/-/,"/"));
                        if(isNull(result.data.caseType))
                            result.data.caseType="海上";
                        _self.shipLoading=true;
        ...
        removeCase(caseId){
            var _self=this;
            this.$http.delete("/enforces/case/"+caseId)
            .then(function(result){
                if(result.success){
                    _self.draftPage();
                }
        ...
        revokeCase(){
            var _self=this;
             _self.$Modal.confirm({
                ...
                content:"请确认是否撤消案件？",
                onOk:function(){
                    _self.$http.delete("/enforces/case/revokeCase/"+_self.caseInfo.id)
                    .then(function(result){
                        if(result.success){
                            _self.$router.go(-1);
                        }
        ...
        draftPage(page){
            var _self=this;
            if(!isEmpty(page))
                this.draft.query.page=page;
            this.$http.get("/enforces/case/page",{
                params:{
        ...
        selectEnforceType(row){
            ...
            this.enforceType.show=false;
            this.$http.get("/enforces/case/enforceNum",{
    ...
    mounted(){
        ...
        if(query.view==="9" || query.view==="4" || query.view==="simpleCaseview"){
            this.ifEdit = true;
        }             
        if(!isNull(query.caseId))      
            this.loadCase(query.caseId);
        this.loadDiscretionaryPower();
        this.initCaseInfo();

        if(this.$route.query.view=='simpleCase'||this.$route.query.view=='simpleCaseview')
            this.$route.meta.title="简易案件";
        else
            this.$route.meta.title="一般案件";
