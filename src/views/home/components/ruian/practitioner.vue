...
export default {
  ...
  methods: {
    init() {
      this.$nextTick(() => {
        this.$http
          .get("/checks/shipsailor/age?type=4&areaCode=330381")
          .then(res => {
            var data_m1 = [];
            var data_m2 = [];
            var data_m3 = [];
            ...
            //   });
            data_m1.push(res.data.less30);
            data_m2.push(res.data.more30less40);
            data_m3.push(res.data.more40less50);
            data_m4.push(res.data.more50less60);
            data_m5.push(res.data.more60);
            ...
            var option = {
              color: ["#A77AF6", "#24D9C7", "#F1C000", "#F27155", "#00B778"],
              legend: {
            ...
            dataSource.on("click", params => {
              var areaCode = this.areaMap.get(params.name);
              this.$router.push({
