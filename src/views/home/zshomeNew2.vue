    ...
    <Row :gutter="10">
          ...
          <Card>
            <p slot="title" class="card-title-select">
              ...
              <span style="margin-right:350px">
                <Select
                  v-model="pieAreaWorkerType.area"
                  placement="bottom"
                  size="small"
                  style="width:100px;margin-right:10px;"
                  :transfer="true"
      ...
      <Col span="9" :style="{marginTop: '10px'}">
        <Row :gutter="10">
          <Card>
            <p slot="title" class="card-title-select">
              <span style="font-size:18px">渔船情况统计</span>
              <span style="margin-right:350px">
                <Select
                  v-model="pieAreaWorkerType.area"
                  placement="bottom"
            ...
            <div style="height:180px">
              <boatSituation :areaCode="pieAreaWorkerType.area"></boatSituation>
            </div>
          </Card>
        </Row>
      </Col>
...
import practitioner from "./components/zhoushang/practitioner";
...
import boatSituation from "./components/zhoushang/boatSituation";
...
export default {
          ...
          render: (h, params) => {
            return h("div", [
              h(
                ...
                100 -
                  parseInt(params.row.ycl.slice(0, params.row.ycl.length - 2)) +
                  "%"
              )
            ]);
            // return h(
  ...
  mounted() {
    ...
    // this.$http
    // .get("https://api.seniverse.com/v3/weather/daily.json?key=rdgphte6um6jz6xh&location=ip&language=zh-Hans&unit=c&start=0&days=1")
    // .then(res => {
    //     console.log(res,'getWeather')
    //     // var w = res.data;
    //     // this.city = w.name;
