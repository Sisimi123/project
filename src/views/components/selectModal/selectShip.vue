...
export default {
  ...
  computed: {
    defaultColumns(){
      console.log("defaultColumns",this.cutomsColumns);
  ...
  methods: {
    ...
    init(){
      ...
      if(this.multiple && !this.isEmpty(this.cutomsUrl)){
        ...
        console.log("initDisableCheckbox");
        this.initDisableCheckbox();
      } else {
        this.initSearch();
      }
    ...
    initCustom(page) {
      console.log("initCustom",this.cutomsUrl);
      this.status.tableLoading = true;
      this.query.page = page;
      this.$http
        .get("/shiparchives/normalnyb/getInfoWithRule", {
          params: {
