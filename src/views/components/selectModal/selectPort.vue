        ...
        <Row>
          <Col span="24">
            <Row>
              <div>
                <span>港口名：</span>
                <Input v-model="query.wheres.portName_like" @on-keydown.enter="initSearch()"  style="width:30%" placeholder="请输入..."></Input>
...
export default {
  ...
  watch: {
    value(val) {
        this.visible = val;
        if (val){
            this.query.wheres.portName_like = this.keyParam;
            this.initSearch();
