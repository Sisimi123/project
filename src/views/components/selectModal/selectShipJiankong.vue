          ...
          <Col span="24">
            ...
            <Row >
              <div style="margin-top:10px">
                <Table :loading="status.tableLoading" :columns="defaultColumns" :data="selectList" :height="280"
  ...
  methods: {
        ...
        this.selectList.forEach(element => {
          ...
          for (const key in this.selectedList) {
            if (this.selectedList.hasOwnProperty(key)) {
              const shipName = this.selectedList[key].b;
              if(element.b == shipName){
                element._checked = true;
                break;
              }
    ...
    initSearch(){
      if(this.status.showDisableShip || !this.multiple){
        ...
        this.cutomsUrlParams.wheres.shipname = this.query.wheres.shipname;
        this.initCustom();
      }
    },
    handleSearch() {
