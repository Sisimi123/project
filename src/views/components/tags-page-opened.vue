...
<template>
    <div ref="scrollCon" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll" class="tags-outer-scroll-con" style="padding:0">
        ...
        <div ref="scrollBody" class="tags-inner-scroll-body" :style="{left: tagBodyLeft + 'px'}">
            <transition-group name="taglist-moving-animation">
                <Tag 
                    ...
                    :color="item.children?(item.children[0].code===currentPageName?'blue':'default'):(item.code===currentPageName?'blue':'default')"
                >{{ itemTitle(item) }}</Tag>
            </transition-group>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        linkTo (item) {
            ...
            this.currentPageName = item.code
        },
        handlescroll (e) {
            var type = e.type;
            let delta = 0;
