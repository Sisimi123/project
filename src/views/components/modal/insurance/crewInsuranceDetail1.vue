                        ...
                        <Tabs type="card" v-model="initial">
                            <TabPane label="基本信息" name="initial">
                                ...
                                <Row>
                                    ...
                                    <Col span="8">
                                        <Form-item label="互保凭号:">
                                            <Input v-model="info.mutuInsuCertNo"/>
                                        </Form-item>
                                    </Col>
                                </Row>
                                <!-- <Row>
...
export default {
    ...
    methods: {
        ...
        initData () {
            this.base = {};
            this.$http
                .get('/standingbook/oneshiponefile/getcrewInsuranceList?id=' + this.id)
                .then(res => {
                    if (res.success) {
                        this.orgin = res.data;
        ...
        initSearch () {
            this.$http.get('/standingbook/oneshiponefile/getcrewInsuranceList?id=' + this.id)
                .then(res => {
        ...
        handleDelete (row,index) {
            ...
            this.$Modal.confirm({
                ...
                cancelText: '返回',
                onOk: () => {
                    this.$http.delete('/standingbook/oneshiponefile/deletecrewInsurance?id='+row.id)
                        .then(res => {
                            if (res.success) {
                                this.initSearch();
                            } else {
        ...
        handleSave () {
            ...
            this.$http.post('/standingbook/oneshiponefile/savecrewInsurance', this.info)
                .then(res => {
                    if (res.success) {
                        this.initSearch();
                    } else {
