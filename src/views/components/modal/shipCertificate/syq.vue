        ...
        <Form :label-width="100" :model="info" :rules="infoRules" ref="info">
            <Tabs type="card" v-model="initial">
                <TabPane label="基本信息" name="initial">
                    <Row>
                        <Col span="8">
                            <Form-item :label-width="180" label="渔业船舶登记证书有效期:" prop="valiDateVessRegiCert">
                                <Input v-model="info.valiDateVessRegiCert" ></Input>  
                            </Form-item>
                        </Col>
                        <Col span="16">
                            <Form-item :label-width="200" label="渔业船舶所有权登记证书编号:" prop="fishVessOwneRegiCertNumb">
                        ...
                        <Col span="7" offset="1">
                        <div>
                            <singleUpload :action="'edit'" :dataId="info.id" :moduleId="'oneshiponefile_cbjy'" :width="150" :height="150"></singleUpload>
                        </div>
                        </Col>
                    </Row>
                    <Row>
...
export default {
    ...
    // default
        ...
        // ----
        handleOk () {
            this.orgin.syq = this.info;
            this.orgin.syq.codefishingArea = this.orgin.organizationCode;
