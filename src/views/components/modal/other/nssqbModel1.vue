...
export default {
    ...
    methods: {
        ...
        initSearch(){
            this.$http.get("/standingbook/oneshiponefile/getShipAnnualReviewList?id="+ this.id)
            .then(res => {
        ...
        handleDelete(row,index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    ...
                    this.$http.delete("/standingbook/oneshiponefile/deleteShipAnnualReview?id="+row.id)
                        .then(res => {
                            if (res.success) {
                                this.initSearch();
                            } else {
        ...
        handleSave() {
            ...
            this.$http.post("/standingbook/oneshiponefile/saveShipAnnualReview", this.info)
                .then(res => {
                    if (res.success) {
                        // this.orgin = res.data;
                        // var data = this.$util.deepCopy(this.orgin.annualReview);
