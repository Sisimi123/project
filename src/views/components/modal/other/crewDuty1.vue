...
export default {
    ...
    methods: {
        ...
        initSearch(){
            this.$http.get("/standingbook/oneshiponefile/getCrewDutyList?id="+ this.id)
            .then(res => {
        ...
        handleDelete(row,index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    ...
                    this.$http.delete("/standingbook/oneshiponefile/deleteCrewDuty?id="+row.id)
                        .then(res => {
                            if (res.success) {
                                this.initSearch();
                            } else {
        ...
        handleSave() {
            ...
            this.$http.post("/standingbook/oneshiponefile//saveCrewDuty", this.info)
                .then(res => {
                    if (res.success) {
                        this.initSearch();
                    } else {
