...
export default {
    ...
    methods: {
        ...
        initSearch(){
            this.$http.get("/standingbook/oneshiponefile/getShipDangerCheckList?id="+ this.id)
            .then(res => {
        ...
        handleDelete(row,index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    ...
                    this.$http.post("/standingbook/oneshiponefile/deleteShipDangerCheck?id="+row.id)
                        .then(res => {
                            if (res.success) {
                                this.initSearch();
                            } else {
        ...
        handleSave() {
            ...
            this.$http.post("/standingbook/oneshiponefile/saveShipDangerCheck", this.info)
                .then(res => {
                    if (res.success) {
                        // this.orgin = res.data;
                        // var data = this.$util.deepCopy(this.orgin.dangerCheck);
