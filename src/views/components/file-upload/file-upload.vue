        ...
        <Row>
                ...
                <Card>
                    ...
                    <div class="height-120px">
                        <Row type="flex" justify="center" align="middle" class="height-100">
                            <Upload action="//jsonplaceholder.typicode.com/posts/" :headers="{'ipInfo': this.$store.state.ipInfo.cip}">
            ...
            <Col span="8" class="padding-left-10">
                <Card>
                    ...
                    <div class="height-120px">
                        <Row type="flex" justify="center" align="middle" class="height-100">
                            <Upload multiple action="//jsonplaceholder.typicode.com/posts/" :headers="{'ipInfo': this.$store.state.ipInfo.cip}">
                                <span>多选文件上传&nbsp;&nbsp;</span>
                                <Button  icon="ios-cloud-upload-outline">上传文件</Button>
                            </Upload>
                        </Row>
