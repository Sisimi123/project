<template>
    <div>
        <data-table ref='test'
            :url="'/supervision/safetyCheck/safetyPage'"
            :params="query"
            :columns="columns"
        ...
        <safetyEntryModal :isView='true' :checkType="'SAFTY'" moduleIdName='dailyCheckEntry' :taskid='taskid' :info='info' :width="1200" v-model="status.entryModal" @visibleChange="statusChange" :mask-closable="maskclosable" :styles="{top: '20px','z-index':1000}"></safetyEntryModal>
    </div>
</template>
